...
namespace Fargowiltas.Content.NPCs
{
    ...
    public class Deviantt : ModNPC
    {
        ...
        public override bool CanTownNPCSpawn(int numTownNPCs)
        {
            ...
            return FargoServerConfig.Instance.Devi && !(Main.CurrentFrameFlags.AnyActiveBossNPC || FargoUtils.NPCIndexIsValid(ref FargoGlobalNPC.eaterBoss, NPCID.EaterofWorldsHead))
